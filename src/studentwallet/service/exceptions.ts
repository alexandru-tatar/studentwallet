 ...
 */
export class MatrNrExistsException extends HttpException {
    readonly matrnr: string | undefined;

    constructor(matrnr: string | undefined) {
        super(
            `Die Matrikel-Nummer ${matrnr} existiert bereits.`,
